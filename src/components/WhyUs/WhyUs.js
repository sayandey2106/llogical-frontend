...
<div class="container">
        <div class="row">
            <div class="container text-center pt-5">
                <h2 class="learn-text font-fam-bold" >Why <span class="why-log" ><b>LLOGICAL</b> ?</span></h2>
        ...
        <div class="row">
            <div class="container py-5">
                <div class="col-12 col-md-12 why-phy-box d-flex align-items-center text-center p-3 cflx">
                    <div className='row'>
                    <div class="col-12 col-md-3 col-sm-12 d-flex justify-content-center"><img class="img-fluid" alt="img11" src="https://www.pw.live/version14/assets/img/group-20356.svg"/></div>
                    <div class="col-12 col-md-9 col-sm-12">
                        <div class="d-flex flex-column">
                            <div class="why-inner-head font-fam-bold px-4">Live / Scheduled Lectures</div>
                ...
                <div class="col-12 col-md-12 why-phy-box-inn d-flex align-items-center p-3 cflx">
                    <div className='row'>                    
                    <div class="col-12 col-md-3 col-sm-12 d-flex justify-content-center d-md-none"><img class="img-fluid" alt="img11" src="https://www.pw.live/version14/assets/img/group-20360.svg" width="220" height="220"/></div>
                ...
                <div class="col-12 col-md-12 why-phy-box-inn d-flex align-items-center p-3 cflx">
                    <div className='row'>
                    <div class="col-12 col-md-3 col-sm-12 d-flex justify-content-center"><img class="img-fluid" alt="img11" src="https://www.pw.live/version14/assets/img/group-20358.svg"/></div>
                    <div class="col-12 col-md-9 col-sm-12">
                        <div class="d-flex flex-column">
                ...
                <div class="col-12 col-md-12 why-phy-box-last d-flex align-items-center p-3 cflx">
                    <div className='row'>
                    <div class="col-12 col-md-3 col-sm-12 d-flex justify-content-center d-md-none"><img class="img-fluid" alt="img11" src="https://www.pw.live/version14/assets/img/group-20359.svg"/></div>
                    <div class="col-12 col-md-9 col-sm-12">
                        <div class="d-flex flex-column">
                    ...
                    <div class="col-12 col-md-3 col-sm-12 d-flex justify-content-center"><img class="img-fluid d-md-block d-none" alt="img11" src="https://www.pw.live/version14/assets/img/group-20359.svg"/>
                    </div>
                    </div>
                </div>
            </div>
